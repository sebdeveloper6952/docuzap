	...
	<div class="w-full md:max-w-screen-md">
		<div class="grid grid-cols-1 md:grid-cols-3 gap-2">
			{#each $userFilesStore as file}
				<div
					class="w-full max-w-48 h-48 p-1 flex flex-col justify-center items-center text-primary-900/75 bg-primary-100/25 rounded"
				>
					...
					<div class="flex flex-col flex-1 justify-center items-center">
						...
						<p class="font-bold text-xs">{file.name}</p>
					</div>
					<div class="w-full flex justify-end">
